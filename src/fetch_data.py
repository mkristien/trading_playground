...
parser.add_argument("--no-write", dest="write", action="store_false", help="Do not store data into csv file")
...
if __name__ == "__main__":
    ...
    date_series, price_series = util.my_web.fetch_data(args.stock)

    if args.display:
        util.my_plot.plot_values(date_series, price_series)

    if args.write:
        util.my_file.store_csv(args.stock, date_series, price_series)
